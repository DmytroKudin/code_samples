...
use App\Models\ContactActivityEventTwo;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\DB;

class SeedTwoTable extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:seed-two-table';
    ...
    public function handle()
    {
        ...
        for ($i = 0; $i < $numberOfRecords / $batchSize; $i++) {
            ...
            DB::transaction(function () use ($batchSize) {
                ContactActivityEventTwo::factory($batchSize)->create();
            });
